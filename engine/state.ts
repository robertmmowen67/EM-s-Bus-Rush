...
export type GlobalModifierKey = "weekend_service" | "fare_hike" | "late_night_service" | "bridge_reconstruction";

export interface ActiveGlobalModifier {
  key: GlobalModifierKey;
...
export interface GameState {
  ...
  activeGlobalModifiers: ActiveGlobalModifier[];
